package ua.lviv.lgs.magazine.repository.impl;
...
import ua.lviv.lgs.magazine.repository.mapper.UserMapper;
...
public class UserRepositoryImp implements UserRepository {
    private final static String CREATE = "insert into users(`email`, `password`, `first_name`, `last_name`, `role`) values (?,?,?,?,?)";
